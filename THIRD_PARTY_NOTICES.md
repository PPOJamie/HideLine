...
- The bundled Central London water-edge atlas is a simplified planning snapshot aligned to OpenStreetMap geometry and carries OpenStreetMap contributor/ODbL attribution. It covers the major named waters needed for game play but is not a surveyed hydrological dataset; imported official or game-map geometry may replace matching built-in features when it supplies a valid line or polygon.
